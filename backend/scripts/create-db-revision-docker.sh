...
uv run --directory "$BACKEND_DIR" ruff format src/neurocache/migrations/versions/
uv run --directory "$BACKEND_DIR" ruff check --fix src/neurocache/migrations/versions/
