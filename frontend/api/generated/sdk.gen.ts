 ...
 */
export const listKnowledgeSources = <ThrowOnError extends boolean = false>(
  options?: Options<ListKnowledgeSourcesData, ThrowOnError>
) =>
  (options?.client ?? client).get<
    ListKnowledgeSourcesResponses,
    unknown,
 ...
 */
export const createKnowledgeSource = <ThrowOnError extends boolean = false>(
  options: Options<CreateKnowledgeSourceData, ThrowOnError>
) =>
  (options.client ?? client).post<
    CreateKnowledgeSourceResponses,
    CreateKnowledgeSourceErrors,
 ...
 */
export const getKnowledgeSourceDefaults = <
  ThrowOnError extends boolean = false,
>(
  options?: Options<GetKnowledgeSourceDefaultsData, ThrowOnError>
) =>
  (options?.client ?? client).get<
    GetKnowledgeSourceDefaultsResponses,
    unknown,
 ...
 */
export const deleteKnowledgeSource = <ThrowOnError extends boolean = false>(
 ...
 */
export const getKnowledgeSource = <ThrowOnError extends boolean = false>(
  options: Options<GetKnowledgeSourceData, ThrowOnError>
) =>
  (options.client ?? client).get<
    GetKnowledgeSourceResponses,
    GetKnowledgeSourceErrors,
 ...
 */
export const updateKnowledgeSource = <ThrowOnError extends boolean = false>(
  options: Options<UpdateKnowledgeSourceData, ThrowOnError>
) =>
 ...
 */
export const ingestAllDocuments = <ThrowOnError extends boolean = false>(
  options: Options<IngestAllDocumentsData, ThrowOnError>
) =>
  (options.client ?? client).post<
    IngestAllDocumentsResponses,
    IngestAllDocumentsErrors,
 ...
 */
export const searchKnowledgeSource = <ThrowOnError extends boolean = false>(
  options: Options<SearchKnowledgeSourceData, ThrowOnError>
) =>
  (options.client ?? client).get<
    SearchKnowledgeSourceResponses,
    SearchKnowledgeSourceErrors,
...
export const listThreads = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<ListThreadsResponses, unknown, ThrowOnError>({
    responseType: "json",
    url: "/api/threads",
    ...options,
  });
...
export const getMyself = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<GetMyselfResponses, unknown, ThrowOnError>({
    responseType: "json",
 ...
 */
export const updateMyPersonalization = <ThrowOnError extends boolean = false>(
  options: Options<UpdateMyPersonalizationData, ThrowOnError>
) =>
  (options.client ?? client).patch<
    UpdateMyPersonalizationResponses,
    UpdateMyPersonalizationErrors,
